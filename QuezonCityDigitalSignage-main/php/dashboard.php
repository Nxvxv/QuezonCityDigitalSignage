...
<body class="h-full bg-gray-50 text-gray-900 font-montserrat">
  ...
  <div id="logout-loader" class="hidden fixed inset-0 z-60 flex items-center justify-center bg-black bg-opacity-50">
    <div class="loader-box bg-white p-6 rounded flex items-center space-x-4">
      <div class="loader"></div>
      <div class="text-gray-700 font-medium">Logging out...</div>
    </div>
  </div>

  <style>
    /* User-provided loader styles */
    .loader {
      width: 45px;
      height: 40px;
    ...
    .loader-box { box-shadow: 0 6px 18px rgba(0,0,0,0.15); }

    @keyframes matrix {
      0% { background-position: 0 0, 0 0, 0 0; }
      100% { background-position: 0 400%, 0 400%, 0 400%; }
    }

    /* ensure modal overlays sit above other UI */
    #logout-loader { z-index: 9999; }
    #logout-confirmation { z-index: 9998; }
  </style>
