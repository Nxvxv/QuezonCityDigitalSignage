...
<body class="h-full bg-gray-50 text-gray-900 font-montserrat">
  ...
  <a id="preview-signage" href="Signage.php" class="bg-primary text-white px-4 py-2 rounded hover:bg-blue-700 inline-block text-center">Preview Signage</a>
      </header>
  ...
  <div id="footer-modal" class="hidden fixed inset-0 z-40 flex items-center justify-center">
    ...
    <div class="relative bg-white rounded shadow-lg w-11/12 md:w-2/3 lg:w-1/2 p-6 max-h-[80vh] overflow-auto">
      <div class="flex justify-between items-center mb-4">
        <h4 id="footer-modal-title" class="text-lg font-semibold">New Footer Message</h4>
      ...
      <form id="new-footer-form" class="space-y-3 mb-6">
        ...
        <div class="flex space-x-2">
          <button id="footer-submit-btn" type="submit" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">Create &amp; Save</button>
